...
<section class="gpg-services gpg-scroll-reveal" id="diensten">
  <div class="gpg-container" style="position:relative;z-index:1;">
    <div style="text-align:center;margin-bottom:2rem;">
      <span class="gpg-badge">Onze diensten</span>
      <h2>Complete facilitaire ondersteuning</h2>
      <p style="color:var(--gpg-gray);max-width:36rem;margin:0 auto;">Van verhuizingen tot volledige kantoorinrichtingen. Wij bieden alles wat je nodig hebt.</p>
    </div>

    <div class="gpg-services-grid">
      <?php foreach ( $services as $index => $service ) : ?>
      <a href="<?php echo esc_url( $service['href'] ); ?>" class="gpg-service-card gsa-hoek-sm">
        <div class="card-header">
          <div class="icon-wrap"><?php echo $icons[ $service['icon'] ]; ?></div>
          <div>
        ...
        <div class="card-footer">
          ...
          <div class="arrow-circle"><?php echo $arrow_icon; ?></div>
        </div>
      </a>
      <?php endforeach; ?>
    </div>
    ...
    <div style="text-align:center;margin-top:2rem;">
      <a href="/diensten/" class="gpg-btn gpg-btn-outline gsa-hoek-sm">Bekijk alle diensten <?php echo $arrow_icon; ?></a>
    </div>
  </div>
</section>