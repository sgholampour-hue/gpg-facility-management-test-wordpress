...
<section class="gpg-cta gpg-scroll-reveal" id="contact">
  <div class="gpg-container">
    <div class="gpg-cta-card gsa-hoek-lg">
      <div class="gpg-cta-inner">
        <!-- Left: Content -->
        <div class="gpg-cta-content">
          <span class="gpg-badge">Neem contact op</span>
          <h2>Klaar om te starten?</h2>
          <p style="color:var(--gpg-gray);margin-bottom:1.5rem;">Neem vandaag nog contact met ons op voor een vrijblijvend adviesgesprek. Wij helpen je graag bij jouw volgende project.</p>

          <div class="gpg-cta-contacts">
        ...
        <div class="gpg-cta-image">
          ...
          <div class="gpg-overlay-gradient-lr"></div>
